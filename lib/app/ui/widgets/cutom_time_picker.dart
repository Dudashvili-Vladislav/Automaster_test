...
/// See also:
///
/// * [showTimePicker], a function that shows a [CustomTimePicker] and returns
...
class _TimePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const _HourDialType hourDialType = _HourDialType.twelveHour;
    ...
    return SizedBox(
      ...
      child: Ink(
        decoration: BoxDecoration(
          color: isSelected
              ? AppColors.main.withOpacity(.34)
              : const Color(0xFF212121).withOpacity(.08),
...
class _AmPmButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: selected ? AppColors.main.withOpacity(.34) : Colors.white,
      ),
      child: InkWell(
        ...
        child: Semantics(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 14.0,
                color: selected ? AppColors.main : Colors.black.withOpacity(.6),
              ),
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    painter = _DialPainter(
      ...
      backgroundColor: const Color(0xFF212121).withOpacity(.08),
      handColor: AppColors.main,
...
class CustomTimePicker extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [CustomTimePicker].
  ///
...
class _CustomTimePickerState extends State<CustomTimePicker>
  ...
  void _handleOk() {
    ...
    widget.onTimeChanged?.call(_selectedTime.value);
    Navigator.pop(context);
  }
  ...
  Size _dialogSize(BuildContext context, {required bool useMaterial3}) {
    ...
    final double textScaleFactor =
        math.min(MediaQuery.textScaleFactorOf(context), 1.1);
            ...
            child: SizedBox.fromSize(
              ...
              child: AspectRatio(
                ...
                child: _Dial(
                  ...
                  hourDialType: _HourDialType.twentyFourHourDoubleRing,
                  selectedTime: _selectedTime.value,
...
Future<TimeOfDay?> showTimePicker({
  ...
  final Widget dialog = CustomTimePicker(
